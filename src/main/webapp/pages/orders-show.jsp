        ...
        <section class="content">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="订单编号"
							   value="${att_orders.orderNum }" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								   ...
								   value="${att_orders.orderTimeStr}">
						</div>
					</div>
					<div class="col-md-2 title">路线名称</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="路线名称"
							   value="${att_orders.product.productName }" readonly="readonly">
					</div>

					<div class="col-md-2 title">出发城市</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出发城市"
							   value="${att_orders.product.cityName }" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<p>${att_orders.product.departureTimeStr}</p>
							<input type="text" class="form-control pull-right"
								   id="datepicker-a6" value="${att_orders.product.departureTimeStr}"
								   readonly="readonly">
						</div>
					</div>
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出游人数"
							   value="${att_orders.peopleCount}" readonly="readonly">
					</div>
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data text">${att_orders.member.nickname }</div>

                    <div class="col-md-2 title">联系人</div>
                    <div class="col-md-4 data text">${att_orders.member.name}</div>

                    <div class="col-md-2 title">手机号</div>
                    <div class="col-md-4 data text">${att_orders.member.phoneNum}</div>

                    <div class="col-md-2 title">邮箱</div>
                    <div class="col-md-4 data text">${att_orders.member.email}</div>
